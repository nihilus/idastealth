...
#define DRV_YEAR               2009 // current year or timespan (e.g. 2003-2007)
#define TEXT_WEBSITE           http:/##/www.newgre.net // website
...
#define TEXT_MODULE            RDTSCEmu // module name
...
#define TEXT_INTERNALNAME      RDTSCEmu.sys // copyright information
